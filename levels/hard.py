...
grassImage = os.path.join(
    root_dir, "../cars_racing_simple_game/images", "grass3.jpg")
trackImage = os.path.join(
    root_dir, "../cars_racing_simple_game/images", "track_style2.png")
...
pygame.display.set_caption("Cars Racing Simple Game 2024 [Hard Mode]")
